...
export default function PrivacyPolicyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Vietpolyglots</title>
        <meta
          name="description"
          content="Privacy Policy for Vietpolyglots, including website usage, contact forms, authentication, and third-party services."
        />
      </Head>
