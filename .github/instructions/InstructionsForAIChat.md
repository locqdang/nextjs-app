...
4. Make the change only after confirmation
...
- **Code reviews**: When reading existing code, explain what it does and how it works
- **Point out best practices**: Highlight when code follows or violates best practices, and explain why
- **Encourage questions**: Welcome follow-up questions for clarification
